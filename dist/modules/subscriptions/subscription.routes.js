 ...
 */
router.get('/my', subscription_controller_1.subscriptionController.getMySubscription);
/**
 * @swagger
 ...
 */
router.post('/subscribe', (0, validate_1.validate)(subscription_validation_1.planIdSchema), subscription_controller_1.subscriptionController.subscribe);
/**
 * @swagger
 ...
 */
router.post('/apply', (0, validate_1.validate)(subscription_validation_1.planIdSchema), subscription_controller_1.subscriptionController.apply);
// ── ADMIN ROUTES ──────────────────────────────────────────
 ...
 */
router.get('/admin/plans', subscription_controller_1.subscriptionController.adminGetPlans);
/**
 * @swagger
 * /api/subscriptions/admin/plans:
 *   post:
 ...
 */
router.post('/admin/plans', (0, validate_1.validate)(subscription_validation_1.createPlanSchema), subscription_controller_1.subscriptionController.adminCreatePlan);
/**
 * @swagger
 ...
 */
router.put('/admin/plans/:id', (0, validate_1.validate)(subscription_validation_1.updatePlanSchema), subscription_controller_1.subscriptionController.adminUpdatePlan);
/**
 * @swagger
 ...
 */
router.get('/admin/requests', subscription_controller_1.subscriptionController.adminGetRequests);
/**
 * @swagger
 ...
 */
router.patch('/admin/requests/:id', (0, validate_1.validate)(subscription_validation_1.reviewRequestSchema), subscription_controller_1.subscriptionController.adminReviewRequest);
