...
exports.sendPasswordResetEmail = exports.sendPasswordChangedEmail = exports.sendOTPEmail = exports.sendEmail = void 0;
const nodemailer_1 = __importDefault(require("nodemailer"));
const env_1 = require("../config/env");
const createTransporter = () => {
    return nodemailer_1.default.createTransport({
        host: env_1.env.EMAIL_HOST,
        port: Number(env_1.env.EMAIL_PORT) || 587,
        secure: env_1.env.EMAIL_SECURE === 'true',
        auth: {
...
const emailTemplate = (title, bodyContent) => `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8"/>
...
const sendEmail = async (options) => {
    try {
        if (env_1.env.NODE_ENV === 'development' && !env_1.env.EMAIL_USER) {
        ...
        const info = await transporter.sendMail({
            from: `"${env_1.env.EMAIL_FROM_NAME || 'MY EMDR'}" <${env_1.env.EMAIL_FROM || env_1.env.EMAIL_USER}>`,
            to: options.to,
